...
\end{itemize}
Attention: Pour savoir s'il faut utiliser + ou -- dans la formule, il faut voire ils s'éloignent ou s'approchent. Dans le premier cas la fréquence augmente et dans l'autre elle diminue.
\pagebreak
